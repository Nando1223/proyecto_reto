            ...
            <main>
                <div class="container-fluid">
                    ...
                    if (isset($_POST['nombreInput'])) {
                        ...
                        $query = "INSERT INTO `persona`(`nombre`, `apellidos`, `cedula`, `tipo_indentificacion`) VALUES ('$nombre', '$apellidos', '$cedula', '$tipo_indentificacion')";
                    ...
                    <form class="form-horizontal" method="POST" action="crear_usuario.php" autocomplete="off">

                        <div class="form-group">
                            <label for="nombreInput">Nombre</label>
                            <input type="text" class="form-control" id="nombreInput" placeholder="Ingrese Nombre" name="nombreInput">
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Ingrese Apellido" name="apellidos">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-number" id="exampleInputPassword1" placeholder="Ingrese Cedula" name="cedula">
                            </div>
