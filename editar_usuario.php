            ...
            <main>
                <div class="container-fluid">
                    ...
                    if (isset($_POST['nombre'])) {
                        ...
                        $cedula = $_POST['cedula'];
                        $identificacion = $_POST['tipo_indentificacion'];
                        //$link = "Location: editar.php?id='$id'";
                        try {
                            $sql = "UPDATE persona SET nombre = '$nombre', apellidos = '$apellido', cedula = '$cedula', tipo_indentificacion = '$identificacion' WHERE id = '$id' ";
                            //echo  $sql;
                            $resultado = mysqli_query($con, $sql);
                            if ($resultado) {
                    ?>
                                <script>
                                    window.location.assign("consulta_user.php")
                                </script>
                        <?php
                            }
                        } catch (\Throwable $th) {
                        ...
                        <div>
                            ...
                            <form method="post">
                                ...
                                <center>
                                    ...
                                    <a href="consulta_user.php" class="btn btn-danger">Cancelar</a>
                                </center>
                            </form>
